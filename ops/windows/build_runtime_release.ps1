...
try {
    ...
    Copy-Item (Join-Path $repository 'config\prospective_candidate_protocol_v1.json') (Join-Path $staging 'config\prospective_candidate_protocol_v1.json')
    Copy-Item (Join-Path $repository 'MODEL_DISPOSITION_V1.json') (Join-Path $staging 'frozen\MODEL_DISPOSITION_V1.json')
    ...
    Copy-Item (Join-Path $PSScriptRoot 'run_preclose_candidate_shadow.ps1') (Join-Path $staging 'run_preclose_candidate_shadow.ps1')
    Copy-Item (Join-Path $PSScriptRoot 'install_preclose_candidate_shadow_task.ps1') (Join-Path $staging 'install_preclose_candidate_shadow_task.ps1')
