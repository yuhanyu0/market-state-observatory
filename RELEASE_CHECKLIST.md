...
- [x] Seed provenance and old-repository baseline recorded.
- [x] Runtime data and secrets moved outside repository by contract.
- [x] DPAPI and GitHub safe-auth scripts implemented.
- [x] SIP daemon, calendar, lock, recovery, quality, and scheduler implemented.
- [x] Publication firewall and public-data workflow implemented.
- [x] React UI, product docs, tests, screenshots, and performance budget passed.
